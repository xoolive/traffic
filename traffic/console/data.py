...
def main(args):
    ...
    group.add_argument("--aircraft", "-a", dest='aircraft', action='store_true',
            help="followed by registration or transponder identification")
    group.add_argument("--airport", "-p", dest='airport', action='store_true',
            help="followed by IATA, ICAO codes, country or city names")
    group.add_argument("--navaid", "-n", dest='navaid', action='store_true',
            help="followed by navigational beacon name"
            )
    group.add_argument("--operator", "-o", dest='operator', action='store_true',
            help="followed by the name of the operator (list all aircraft)")
    group.add_argument("--stats", "-s", dest='stats', action='store_true',
